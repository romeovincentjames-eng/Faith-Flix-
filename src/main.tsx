...
const MOCK_WORSHIP_SONGS: WorshipSong[] = [
  { id: "song-all-my-life", title: "All My Life", artist: "Romeo Galasso", description: "Original worship song uploaded for Faith Flix.", category: "Worship", duration: "3:24", audioName: "all-my-life.mp3", audioUrl: DEMO_AUDIO_A, coverName: "faith-cross-background.png", coverUrl: "/faith-cross-background.png", uploadedBy: "Romeo Galasso", createdAt: "2026-06-02", albumId: "album-faith-rising", albumType: "EP" },
  { id: "song-hear-the-father-say", title: "Hear the Father Say", artist: "Romeo Galasso", description: "Original worship song uploaded for Faith Flix.", category: "Worship", duration: "4:11", audioName: "hear-the-father-say.mp3", audioUrl: DEMO_AUDIO_B, coverName: "faith-cross-background.png", coverUrl: "/faith-cross-background.png", uploadedBy: "Romeo Galasso", createdAt: "2026-06-02", albumId: "album-faith-rising", albumType: "EP" },
  { id: "song-mock-holy-ground", title: "Holy Ground", artist: "Elevation Worship", description: "Standing in the holy presence of God.", category: "Worship", duration: "4:12", audioName: "", audioUrl: DEMO_AUDIO_C, coverName: "holy-ground.jpg", coverUrl: "https://images.unsplash.com/photo-1555685812-4b943f1cb0eb?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-01-14", albumId: "album-holy-ground", albumType: "Single" },
  { id: "song-mock-worthy", title: "Worthy Is the Lamb", artist: "Faith Flix Worship", description: "Exalting the risen Lamb of God.", category: "Worship", duration: "3:58", audioName: "", audioUrl: DEMO_AUDIO_A, coverName: "worthy.jpg", coverUrl: "https://images.unsplash.com/photo-1438232992991-995b7058bbb3?w=400&q=80", uploadedBy: "Admin", createdAt: "2025-01-01", albumId: "album-worthy", albumType: "Single" },
  { id: "song-mock-grace1", title: "Amazing Grace (My Chains Are Gone)", artist: "Hillsong Creative", description: "A timeless hymn reimagined for modern worship.", category: "Praise", duration: "5:02", audioName: "", audioUrl: DEMO_AUDIO_B, coverName: "grace-songs.jpg", coverUrl: "https://images.unsplash.com/photo-1511516412963-801b050c3434?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-01-24", albumId: "album-grace-songs", albumType: "Album" },
  { id: "song-mock-grace2", title: "Oceans (Where Feet May Fail)", artist: "Hillsong Creative", description: "Walking on water by faith alone.", category: "Praise", duration: "4:45", audioName: "", audioUrl: DEMO_AUDIO_C, coverName: "grace-songs.jpg", coverUrl: "https://images.unsplash.com/photo-1511516412963-801b050c3434?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-01-24", albumId: "album-grace-songs", albumType: "Album" },
  { id: "song-mock-grace3", title: "What a Beautiful Name", artist: "Hillsong Creative", description: "Worshipping at the powerful name of Jesus.", category: "Praise", duration: "5:20", audioName: "", audioUrl: DEMO_AUDIO_A, coverName: "grace-songs.jpg", coverUrl: "https://images.unsplash.com/photo-1511516412963-801b050c3434?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-01-24", albumId: "album-grace-songs", albumType: "Album" },
  { id: "song-mock-raise-ep1", title: "Raise a Hallelujah", artist: "Bethel Music", description: "A battle cry of praise in the storm.", category: "Worship", duration: "4:30", audioName: "", audioUrl: DEMO_AUDIO_B, coverName: "raise-ep.jpg", coverUrl: "https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-03-10", albumId: "album-raise-ep", albumType: "EP" },
  { id: "song-mock-raise-ep2", title: "Goodness of God", artist: "Bethel Music", description: "Declaring the unending goodness of God.", category: "Worship", duration: "5:14", audioName: "", audioUrl: DEMO_AUDIO_C, coverName: "raise-ep.jpg", coverUrl: "https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=400&q=80", uploadedBy: "Admin", createdAt: "2024-03-10", albumId: "album-raise-ep", albumType: "EP" },
  { id: "song-demo-single-refuge", title: "Refuge", artist: "Faith Flix Demo", description: "Demo single — a 30-second preview of the audio player.", category: "Worship", duration: "0:30", audioName: "refuge.mp3", audioUrl: DEMO_AUDIO_C, coverName: "", coverUrl: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=400&q=80", uploadedBy: "Admin", createdAt: "2026-06-03", albumId: "album-demo-single-refuge", albumType: "Single" },
  { id: "song-demo-album-1", title: "His Mercy Endures", artist: "Faith Flix Demo", description: "Demo album track 1 — audio player test.", category: "Praise", duration: "0:30", audioName: "mercy.mp3", audioUrl: DEMO_AUDIO_A, coverName: "", coverUrl: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&q=80", uploadedBy: "Admin", createdAt: "2026-06-03", albumId: "album-demo-psalms", albumType: "Album" },
  { id: "song-demo-album-2", title: "Great Is He", artist: "Faith Flix Demo", description: "Demo album track 2 — audio player test.", category: "Praise", duration: "0:30", audioName: "great.mp3", audioUrl: DEMO_AUDIO_B, coverName: "", coverUrl: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&q=80", uploadedBy: "Admin", createdAt: "2026-06-03", albumId: "album-demo-psalms", albumType: "Album" },
];
...
const MOCK_WORSHIP_ALBUMS: WorshipAlbum[] = [
  ...
  { id: "album-demo-single-refuge", title: "Refuge", artist: "Faith Flix Demo", coverUrl: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=400&q=80", type: "Single", year: "2026", trackIds: ["song-demo-single-refuge"], description: "A demo single — tap Play to test the music player." },
